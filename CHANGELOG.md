...
- Images in list items and table cells no longer disappear after reopening a note. Thanks [@parthiv-krishna](https://github.com/parthiv-krishna) for the suggestion! [#225](https://github.com/bholmesdev/hubble.md/pull/225)
